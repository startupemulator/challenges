...
Наиболее важным аспектом при разработке прогноза погоды мобильного приложения является выбор правильного функционала.

## Основные функции:

 - прогноз погоды (текущуая погода в определенном месте, а также ежедневные, почасовые и даже поминутные обновления);
